...
<%@page import="org.gyzb.platform.web.admin.login.LoginPath"%>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>登录页面</title>
<meta name="keywords" content="七分钱商城后台" />
<meta name="description" content="七分钱商城后台" />
<style type="text/css">
      ...
      <div id="logBack02" style="float:left;width:100%;">
            ...
            <form action="" method="get">
               <ul class="log_tex">
                ...
                <li><button name="" type="button" value="登录"  id="loginBack" class="btnlog">登录</button></li>
               </ul>
               </form>
