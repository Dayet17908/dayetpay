...
<%@page import="com.sevenpay.bms.paymentmanager.topay.toPayCollectDailyPath" %>
									  ...
									  <c:if test="${payment.batStatus =='00'}">
										...
										<c:if test="${payment.batStatus =='02'}">
							  			...
							  			<c:if test="${payment.batStatus =='03'}">
											<font color="red">部分成功 </font>		
										 </c:if>	
										 <c:if test="${payment.batStatus =='04'}">
										 ...
										 <td>${payment.createTime}</td>
                                            ...
                                            <a href="/paymentmanager/showPayments?batNo=${payment.batNo}">查看明细</a><br>
                                            <a href="/paymentmanager/failPayment?batNo=${payment.batNo}">失败明细</a>
											</td>
											<td>	
											 <input type="hidden" name="PaymentbatNo" id="PaymentbatNo" value="${payment.batNo}">
											 <c:if test="${payment.batStatus =='02'}">
