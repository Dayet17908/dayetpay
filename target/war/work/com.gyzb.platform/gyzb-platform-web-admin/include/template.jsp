...
<%
    /*  String _jsVersion = SpringUtils.getBean(SystemInfo.class).getSystemVersion();
     String _cssVersion = SpringUtils.getBean(SystemInfo.class).getSystemVersion();  */
     String _jsVersion = '1.0';
     String _cssVersion = '1.0';
	// 登陆对象
