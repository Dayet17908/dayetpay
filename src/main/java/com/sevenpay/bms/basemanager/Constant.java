package com.sevenpay.bms.basemanager;
...
public class Constant {
	...
	/**
	 * 商户证件类型 扫描件类型： 00 个人身份证  01 税务登记证  02 营业执照 03 开户证件 04商户身份信息 05 银行卡扫描件 06 其他证件
	 */
	...
	public static final String CERTIFY_TYPE_MERCHANT_ACCTID = "03";
