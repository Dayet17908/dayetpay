...
import com.sevenpay.bms.basemanager.merchant.auding.bean.AgencyAudingPath;
		    ...
		    //发送邮件短信
		     if(!StringUtils.isBlank(email)){
		    	 final IPlugin plugin = commonService.getIPlugin();
					...
					messageBean.setContent("<html><body><div style=\"width:700px;margin:0 auto;\"><div style=\"margin-bottom:10px;\">您未能通过七分钱服务商审核,<br/>原因是："+messages+"<br/>如有任何问题,请拨打400-633-0707</div></body></html>");
